...
LogSentinel/
├── src/                # Source code
│   ├── main.py         # Main script (where you'll develop the log analysis)
│   └── utils.py        # Helper functions (e.g., regex, reports, etc.)
├── logs/               # Folder containing log files to analyze
│   └── sample_auth.log # Example log file for testing
